...
func (x *S2C_NoticeMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*S2C_NoticeMsg) ProtoMessage() {}

func (x *S2C_NoticeMsg) ProtoReflect() protoreflect.Message {
	mi := &file_proto_protocol_base_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use S2C_NoticeMsg.ProtoReflect.Descriptor instead.
func (*S2C_NoticeMsg) Descriptor() ([]byte, []int) {
	return file_proto_protocol_base_proto_rawDescGZIP(), []int{2}
}

func (x *S2C_NoticeMsg) GetRetcode() int32 {
	if x != nil {
		return x.Retcode
	}
	return 0
...
func (x *S2C_NoticeMsg) GetNoticeMsg() string {
	if x != nil {
		return x.NoticeMsg
	}
	return ""
...
var file_proto_protocol_base_proto_rawDesc = []byte{
	...
	,
...
var file_proto_protocol_base_proto_goTypes = []interface{}{
	...
	(*S2C_NoticeMsg)(nil), // 3: protocol_base.s2c_NoticeMsg
}
